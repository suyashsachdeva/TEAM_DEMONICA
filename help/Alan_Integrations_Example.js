...
intent(
    ...
    p => {
        p.play(
            "I am a AI voice support bot which can help you with any problem you are facing with the app",
        );
    },
);
...
intent(
    ...
    p => {
        p.play(
            "You can click on the blood bank option to go",
        );
    },
);
...
intent(
    ...
    p => {
        p.play(
            "Yes, if you are in need of blood the go to the blood bank option.",
        );
    },
);

intent(
    'Where can we check the availablity of blood in a blood bank',
    p => {
        p.play(
            "Go to blood banks search the blood bank and then click on the availablity rate option",
        );
    },
);
...
intent(
    ...
    p => {
        p.play(
            'This platform online blood bank platform',
        );
    },
);

question('what do you do', p =>  {
    p.play('I am a AI voice support bot which can help you with any problem you are facing with the app');
});
